...
save('fits/CA_repr.mat','rp','NumCurves','rep_rate','tcalendar')

load('fits/CA_repr.mat')
...
leg=legend('FontSize',8,'Location','best','NumColumns',2);
leg.ItemTokenSize = [10,10];

figure10.PaperUnits = 'centimeters';
figure10.PaperPosition = [.25 .25 11.7 6];
saveas(gcf,'figures/CA_report','epsc')
savefig('figures/CA_report')
